...
parser.add_argument('--save', default='./caldist/EB-30-16-2.pth.tar', type=str, metavar='PATH',
                    help='path to save pruned model (default: none)')
parser.add_argument('--save_1', default='./caldist/EB-30-16-B1-1.pth.tar', type=str, metavar='PATH',
                    help='path to save pruned model (default: none)')
